...
/**
 * Rule to provide a Cassandra context for integration tests. This rule can use/spin up either an embedded Cassandra instance or
...
public class CassandraRule extends ExternalResource {
     ...
     * @return the rule
     */
    public CassandraRule before(final CQLDataSet cqlDataSet) {

        Assert.notNull(cqlDataSet, "CQLDataSet must not be null");
        before.add(new SessionCallback<Void>() {
            @Override
