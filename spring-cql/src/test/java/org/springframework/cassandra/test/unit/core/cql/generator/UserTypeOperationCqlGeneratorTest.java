...
import org.springframework.cassandra.core.cql.generator.UserTypeCqlGenerator;
 ...
 * @param <S> The type of the {@link UserTypeNameSpecification}
 * @param <G> The type of the {@link UserTypeNameCqlGenerator}
 */
public abstract class UserTypeOperationCqlGeneratorTest<S extends UserTypeNameSpecification<?>, G extends UserTypeCqlGenerator<?>> {
