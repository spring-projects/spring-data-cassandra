 ...
 */
public class CassandraTemplate implements MongoOperations, ApplicationContextAware {

	private static final Logger LOGGER = LoggerFactory.getLogger(CassandraTemplate.class);
	 ...
	 * @param databaseName
	 */
	public CassandraTemplate(Mongo mongo, String databaseName) {
	 ...
	 */
	public CassandraTemplate(Mongo mongo, String databaseName, UserCredentials userCredentials) {
	 ...
	 */
	public CassandraTemplate(MongoDbFactory mongoDbFactory) {
	 ...
	 */
	public CassandraTemplate(MongoDbFactory mongoDbFactory, MongoConverter mongoConverter) {
