...
[[cassandra.schema-management.initializing.xml]]
==== Initializing a Keyspace by Using Spring XML

If you want to initialize a database and you can provide a reference to a `SessionFactory` bean, you can use the `initialize-keyspace` tag in the `cassandra` namespace:
