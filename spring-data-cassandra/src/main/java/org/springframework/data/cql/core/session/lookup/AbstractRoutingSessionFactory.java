...
/**
 * Abstract {@link org.springframework.data.cql.core.session.SessionFactory} implementation that routes
...
public abstract class AbstractRoutingSessionFactory implements SessionFactory, InitializingBean {
	...
	/* (non-Javadoc)
	 * @see org.springframework.data.cql.core.session.SessionFactory#getSession()
	 */
	@Override
	...
	protected SessionFactory resolveSpecifiedSessionFactory(Object sessionFactory) throws IllegalArgumentException {
		...
		if (sessionFactory instanceof SessionFactory) {
			...
			throw new IllegalArgumentException(String
					.format("Illegal session factory value. Only [org.springframework.data.cql.core.session.SessionFactory]"
