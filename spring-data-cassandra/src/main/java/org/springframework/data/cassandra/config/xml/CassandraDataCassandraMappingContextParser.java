...
import org.springframework.data.cassandra.config.CassandraDataCassandraMappingContextFactoryBean;
import org.springframework.data.cassandra.config.DefaultDataBeanNames;
import org.springframework.util.StringUtils;
import org.w3c.dom.Element;

/**
 * Spring Data Cassandra XML namespace parser for the &lt;mapping-context&gt; element.
 * 
 * @author Matthew T. Adams
 */
public class CassandraDataCassandraMappingContextParser extends AbstractSimpleBeanDefinitionParser {

	@Override
	protected Class<?> getBeanClass(Element element) {
		return CassandraDataCassandraMappingContextFactoryBean.class;
	}
