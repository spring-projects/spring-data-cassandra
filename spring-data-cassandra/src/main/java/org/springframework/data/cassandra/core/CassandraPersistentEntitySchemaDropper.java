...
public class CassandraPersistentEntitySchemaDropper {
	...
	public void dropUserTypes(boolean dropUnused) {
		...
		createUserTypeSpecifications(userTypes) //
				.stream() //
	 ...
	 * UDTs.
	 *
	 * @return {@link List} of {@link DropUserTypeSpecification}.
	 */
	private List<CqlIdentifier> createUserTypeSpecifications(Collection<UserType> knownUserTypes) {
