...
/**
 * Helpful class to write a user defined type value from a row, with possible type conversion.
 * 
 * @author Fabio Mendes
 */
public class UDTValueWriter extends AbstractColumnWriter {
	
	protected UDTValue udtValue;
	protected UserType udtType;
	private List<String> fieldNames;

	public UDTValueWriter(UDTValue value) {
		super(value);
		this.udtValue = value;
