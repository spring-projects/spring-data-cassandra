...
public class ParameterBinding {
	...
	/**
	 * Creates a new {@link ParameterBinding} for the named parameter using the bindable method invocation parameter as
	 * origin.
	 *
	 * @param name
	 * @return
	...
	/**
	 * Creates a new {@link ParameterBinding} for the indexed parameter using the bindable method invocation parameter as
	 * origin.
	 *
	 * @param position
	 * @return
	...
	/**
	 * Creates a new expression {@link ParameterBinding} for the anonymous parameter.
	 *
	 * @param expression
	 * @return
	 */
	 ...
	 * @author Mark Paluch
	 */
	public sealed interface BindingIdentifier permits Anonymous, Named, Indexed, NamedAndIndexed {

		/**
		 * Creates an anonymous ({@code ?}) that binds by position.
		 *
		 * @return
		 */
		static BindingIdentifier anonymous() {
	...
	/**
	 * Anonymous binding identifier ({@code ?}).
	 */
	enum Anonymous implements BindingIdentifier {
