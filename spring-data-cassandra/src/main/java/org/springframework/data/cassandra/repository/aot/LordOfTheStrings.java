 ...
 * <p>
 * Built on top of JavaPoet, this class introduces additional abstractions such as {@link BetterBuilder},
...
class LordOfTheStrings {
	...
	/**
	 * Create a new {@code BetterBuilder} instance.
	 *
	 * @return a new {@code BetterBuilder}.
	 */
	public static BetterBuilder builder() {
		return new BetterBuilder(CodeBlock.builder());
	}

	/**
	 * Create a new {@code BetterBuilder} instance using the given {@link CodeBlock.Builder}.
	 *
	 * @param builder the {@link CodeBlock.Builder} to use.
	 * @return a new {@code BetterBuilder}.
	 */
	public static BetterBuilder builder(CodeBlock.Builder builder) {
	...
	public static class InvocationBuilder {
		 ...
		 * @return {@code this} builder.
		 */
		public <T> InvocationBuilder arguments(Iterable<? extends T> arguments,
				BiConsumer<? super T, BetterBuilder> consumer) {

			for (T argument : arguments) {
				BetterBuilder builder = builder();
				consumer.accept(argument, builder);
				argument("$L", builder.build());
			}
		...
		/**
		 * Build the {@link CodeBlock} representing the method call and assign it to the given variable. The resulting
		 * CodeBlock should be used as {@link CodeBlock.Builder#addStatement(CodeBlock) statement}.
		 *
	...
	public static class BetterBuilder {
		 ...
		 */
		public BetterBuilder add(String format, @Nullable Object... args) {
		 ...
		 * @return {@code this} builder.
		 */
		public BetterBuilder addStatement(Consumer<StatementBuilder> consumer) {
		 ...
		 */
		public BetterBuilder addStatement(String format, @Nullable Object... args) {
		 ...
		 */
		public BetterBuilder beginControlFlow(String controlFlow, @Nullable Object... args) {
		 ...
		 */
		public BetterBuilder endControlFlow(String controlFlow, @Nullable Object... args) {
		 ...
		 */
		public BetterBuilder nextControlFlow(String controlFlow, @Nullable Object... args) {
	...
	public static class StatementBuilder {
		 ...
		 * @param builderCustomizer the consumer to apply to each element and {@link BetterBuilder}.
		 * @param <T> the type of the elements.
		 * @return {@code this} builder.
		 */
		public <T> StatementBuilder addAll(Iterable<? extends T> elements, String delim,
				BiConsumer<? super T, BetterBuilder> builderCustomizer) {
		...
		public <T> StatementBuilder addAll(Iterable<? extends T> elements, Function<? super T, String> delim,
			...
			for (T element : elements) {
				...
				BetterBuilder builder = new BetterBuilder(CodeBlock.builder());
	 ...
	 */
	abstract static class ReturnBuilderSupport {
	 ...
	 * CodeBlock} must be added as a {@link CodeBlock.Builder#addStatement(CodeBlock)}.
	 */
	static class TypedReturnBuilder extends ReturnBuilderSupport {
		 ...
		 * {@link java.util.Optional#ofNullable(Object)} wrapping if the return type is {@code Optional}.
		 *
